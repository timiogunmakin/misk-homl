...
We can look at a few of our correct (left) and incorrect (right) predictions in the plot below.  When looking at the incorrect predictions, we can rationalize some of the errors (e.g., the actual 4 where we predicted a 1 has a strong vertical stroke compared to the rest of the number's features, the actual 2 where we predicted a 0 is blurry and not well defined.)
...
Use the same regression and/or classification dataset you've been using in the previous module exercises:

1. Apply a KNN model with all features.
2. What value for _K_ optimizes model performance? What does this tell you about your data?
3. How does the model performance compare to your previous models?
4. Which 10 features are considered most influential? Are these the same features that have been influential in previous models?
