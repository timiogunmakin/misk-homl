...
<br><br><br><br><br>
# .font140[Decision Trees, Bagging, <br>& Random Forests]
...
```{r maxdepth, echo=FALSE, include=FALSE}
maxdepth <- 1:15
...
animated_p <- animate(p, renderer = gifski_renderer(), device = "png")
```
...
```{r minbucket, echo=FALSE, include=FALSE}
minbucket <- 1:15
results <- data.frame(NULL)
...
```{r, echo=FALSE, fig.height=4.5, include=FALSE}
...
```{r, echo=FALSE, fig.height=4, fig.width=8, include=FALSE}
...
vip::vip(impurity, num_features = 25, geom = "point") + ggtitle("Impurity-based variable importance")
```
...
vip::vip(permutation, num_features = 25, geom = "point") + ggtitle("Permutation-based variable importance")
```
...
---
# Initial Implementation - training .red[`r anicon::faa("hand-point-right", color = "red", animate = "horizontal")` code chunk 2]
...
# Initial Implementation - results .red[`r anicon::faa("hand-point-right", color = "red", animate = "horizontal")` code chunk 3]
...
# Characteristics to Consider .red[`r anicon::faa("hand-point-right", color = "red", animate = "horizontal")` code chunk 4-5]
...
# Tuning .red[`r anicon::faa("hand-point-right", color = "red", animate = "horizontal")` code chunk 6]
...
# Tuning .red[`r anicon::faa("hand-point-right", color = "red", animate = "horizontal")` code chunk 7]
...
# Tuning results .red[`r anicon::faa("hand-point-right", color = "red", animate = "horizontal")` code chunk 8]
...
---
# Feature Importance  .red[`r anicon::faa("hand-point-right", color = "red", animate = "horizontal")` code chunk 9] <a href="https://koalaverse.github.io/vip/index.html"><img src="images/logo-vip.png" class="pdp-hex", align="right"></a>
...
---
# Feature Effects .red[`r anicon::faa("hand-point-right", color = "red", animate = "horizontal")` code chunk 10-11] <a href="https://bgreenwell.github.io/pdp/index.html"><img src="images/pdp-logo.png" class="pdp-hex", align="right"></a>
...
# Feature Effects  .red[`r anicon::faa("hand-point-right", color = "red", animate = "horizontal")` code chunk 12-13] <a href="https://bgreenwell.github.io/pdp/index.html"><img src="images/pdp-logo.png" class="pdp-hex", align="right"></a>
...
# Feature Effects .red[`r anicon::faa("hand-point-right", color = "red", animate = "horizontal")` code chunk 14] <a href="https://bgreenwell.github.io/pdp/index.html"><img src="images/pdp-logo.png" class="pdp-hex", align="right"></a>
