...
```{python vizualize-missing, eval=FALSE}
...
```{python vizualize-missing-output, fig.width=12, fig.height=6, echo=FALSE}
# can you identify patterns of missing data
# missingness is represented with white
p = msno.matrix(ames_raw, labels=True, filter="bottom", sort="ascending", n=50)
p_fig = p.get_figure()
p_fig.savefig('images/vizualize-missing.png', bbox_inches = 'tight')
```

```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("images/vizualize-missing.png")
```


```{python vizualize-missing2, eval=FALSE}
...
```{python vizualize-missing2-output, fig.width=12, fig.height=6, echo=FALSE}
# can you identify patterns of missing data
# missingness is represented with white
p = msno.bar(ames_raw, labels=True, filter="bottom", sort="ascending", n=50)
p_fig = p.get_figure()
p_fig.savefig('images/vizualize-missing2.png', bbox_inches = 'tight')
```

```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("images/vizualize-missing2.png")
```
