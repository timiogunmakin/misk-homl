...
Using the same dataset as you used in the [feature engineering](https://misk-data-science.github.io/misk-homl/docs/03-engineering.nb.html#exercises) and [linear regression](https://misk-data-science.github.io/misk-homl/docs/04-linear-regression.nb.html#exercises) exercises:

1. Apply a ridge model with glmnet.
