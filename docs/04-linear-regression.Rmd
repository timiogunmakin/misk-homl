...
> ___Note___: _Typically, these error metrics are computed on a separate validation set or using cross-validation as discussed in Section 2.4; however, they can also be computed on the same training data the model was trained on as illustrated here._
...
Using the same dataset as you used in the previous module's [exercise](https://misk-data-science.github.io/misk-homl/docs/03-engineering.nb.html#exercises):
